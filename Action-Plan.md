# Table of Contents
- [IO Action Plan](#io-action-plan-issue-for-discussion)
    - [Terms and Conventions](#terms-and-conventions-issue-for-discussion)
    - [Legend](#legend-issue-for-discussion)
- [Non-Conflicting Improvements](#non-conflicting-improvements-issue-for-discussion)
...
- [Changes with Backwards-Compatible Support](#changes-with-backwards-compatible-support-issue-for-discussion)
...
- [Changes with No Backwards-Compatible Support](#changes-with-no-backwards-compatible-support-issue-for-discussion)
...
- [Controversial Changes](#controversial-changes-issue-for-discussion)
...
- [Removals](#removals-issue-for-discussion)
...
- [Bug Fixes](#bug-fixes-issue-for-discussion)
    - [RT Tickets](#rt-tickets-issue-for-discussion)
    - [GitHub Issues](#github-issues-issue-for-discussion)
    - [Other Issues](#other-issues-issue-for-discussion)
# IO Action Plan
