...
and it brings me joy to look back and see Perl 6 stuff improved due to this grant.
...
- **[The Definitive I/O Guide](https://docs.perl6.org/language/io-guide).**
    ...
    (N.B. as I write this report, the guide could still use a couple of extra
...
Many commits went into going through the IO routine list, and adding
...
[800 lines of tests](https://github.com/perl6/roast/blob/d36b8371304a5e62aa5669c1f2cd85c73a8de343/S32-io/io-cathandle.t) and [793 lines of documentation](https://github.com/perl6/doc/blob/856e8465096f51c699c6c68ff8dba4ea641f6b03/doc/Type/IO/CatHandle.pod6) being
written.
...
that will eventually let us get rid of using libuv for syncronous IO.

Along with fixing a bunch of bugs, this work altered the performance landscape
for IO operations (i.e. some operations may not be faster, others slower),
though overall the performance appeared to stay the same.
