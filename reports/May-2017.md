...
- [RT#125463 $non-existent-file.IO.unlink returns True](https://rt.perl.org/Ticket/Display.html?id=125463) (rejected OP issue; left open for another JVM-only issue)
