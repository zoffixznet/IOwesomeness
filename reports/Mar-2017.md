...
of internal buffer sized to about `65536 (* 2)?`
characters fills up and isn't read from
fast enough. I'm unsure whether this should be considered a bug. Filed as
