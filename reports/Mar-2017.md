...
decisions in `newio`: all of the abstractions are of IO objects
...
- Found that IO::Pipe apparently refuses to take more data if some sort
of internal buffer sized to about fills up and isn't read from fast enough.
I'm unsure whether this should be considered a bug. Filed as
